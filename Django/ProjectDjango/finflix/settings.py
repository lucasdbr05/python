"""
Django settings for finflix project.
...
SECRET_KEY = 'django-insecure-095+du2ml38qk(#(h@t+35tf+%*7fi9!)l3qv%st!sg8+hj_8z'
...
WSGI_APPLICATION = 'finflix.wsgi.application'
